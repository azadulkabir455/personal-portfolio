  ...
  return (
    ...
    >
      <Controller
        ...
        name="cv"
        render={({ field }) => (
          <Container className="mb-2 flex w-full flex-row items-center gap-3 md:mb-0 min-[1400px]:w-[60%]">
            <FileInput
      ...
      <Controller
        ...
        name="favicon"
        render={({ field }) => (
          <Container className="flex w-full flex-row items-center gap-3 min-[1400px]:w-[60%]">
            <FileInput
              containerClassName="min-w-0 flex-1"
              label="Favicon"
              value={field.value}
